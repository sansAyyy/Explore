...
namespace Explore.CustomerAccountService.Infrastructure.MessageCenter;

public sealed class MessageCenterClient : IMessageCenterClient
{
    private const string PhoneLoginTemplateCode = "customer_auth.phone_login_code.sms";
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            TemplateCode = PhoneLoginTemplateCode,
            Channel = 1,
