...
public sealed class CustomerRefreshTokenService : ICustomerRefreshTokenService, IScopeDependency
{
    private const string RefreshTokenCacheKeyPrefix = "customer-auth:refresh:";
    ...
    public async Task<RefreshTokenIssueResult> CreateAsync(Guid userId, CancellationToken cancellationToken)
    {
        ...
        return new RefreshTokenIssueResult($"{sessionId:N}.{secret}", expiresAt);
    }
